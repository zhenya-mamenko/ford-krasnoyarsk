	...
	<div>
		<div className="band info-block">
			<div className="container">
				<div className="row">
					<div className="info-block-head col-md-12 col-sm-12 col-xs-12">{strings.header}</div>
					<div className="col-md-12 col-sm-12 col-xs-12 info-block-list">
					...
					<div className="col-md-12 col-sm-12 col-xs-12">{strings.additional}</div>
				</div>
			</div>
		</div>
	</div>
