...
import cover_image from './i/cover_may.jpg';
		...
		return (
			<div>
				...
				<Info strings={ {
					...
					col1: <span>Скидка до 295 000 руб.<sup>1</sup></span>,
				...
				<Disclaimer>
					<p>
						...
						<br />Также подробности можно уточнить по тел. <span className="callibri_phone">+7 (391) 205-45-15</span> в рабочее время автосалона «Форд Центр Редут».
					</p>
				</Disclaimer>
				<Modal
